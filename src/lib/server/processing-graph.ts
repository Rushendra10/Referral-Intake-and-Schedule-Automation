...
const ProcessingState = Annotation.Root({
  referralId: Annotation<string>(),
  documentUrl: Annotation<string>(),
  documentMetadata: Annotation<Record<string, string>>(),
  rawText: Annotation<string>(),
  ocrPages: Annotation<string[]>(),
  candidateFields: Annotation<CandidateFields>(),
  normalizedFields: Annotation<NormalizedFields>(),
  validationFindings: Annotation<string[]>(),
  warnings: Annotation<string[]>(),
  extractedReferral: Annotation<ExtractedReferral | null>(),
  workflowStatus: Annotation<"running" | "completed" | "failed">(),
});
